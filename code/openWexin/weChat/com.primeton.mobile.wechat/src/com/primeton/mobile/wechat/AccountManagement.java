...
public class AccountManagement {
	...
	public static WechatQRCodeModel createTempQRImage(String accessToken, long expireSeconds, int qrID) throws IOException, WechatExceprion{
		...
		RequestEntity requestEntity = new StringRequestEntity(jsonObj.toJSONString(), IWechatConstants.CONTENT_TYPE, IWechatConstants.DEFAULT_CHARSET);
