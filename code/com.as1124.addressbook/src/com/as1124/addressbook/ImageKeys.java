...
public interface ImageKeys {
	...
	// 编辑器相关
	public static final String IMG_FORM_BG = "icons/editors/form_banner.gif";
	public static final String IMG_HORIZONTAL = "icons/editors/th_horizontal.gif";
	public static final String IMG_VERTICAL = "icons/editors/th_vertical.gif";
