...
public class ShakeDeviceManager {
	...
	public DeviceApplication applyDeviceID(String accessToken, int quantity, String reason, String comment, long poiID) throws IOException, ThirdPartyRequestExceprion{
	...
	public boolean updateDeviceInfo(String accessToken, DeviceIdentify deviceIdentify, String reason, String comment) throws IOException, ThirdPartyRequestExceprion{
	...
	public boolean bindDeviceWithPoi(String accessToken, DeviceIdentify deviceIdentifier, long poiID) throws IOException, ThirdPartyRequestExceprion{
